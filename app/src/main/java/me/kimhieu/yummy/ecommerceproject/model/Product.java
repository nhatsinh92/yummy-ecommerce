...
public class Product {
     ...
     * @param purchaseable
     */
    public Product(String title, Integer id, String createdAt, String updatedAt, String type, String status, Boolean downloadable, Boolean virtual, String permalink, String sku, String price, String regularPrice, String salePrice, String priceHtml, Boolean taxable, String taxStatus, String taxClass, Boolean managingStock, Object stockQuantity, Boolean inStock, Boolean backordersAllowed, Boolean backordered, Boolean soldIndividually, Boolean purchaseable, Boolean featured, Boolean visible, String catalogVisibility, Boolean onSale, String productUrl, String buttonText, Object weight, Dimensions dimensions, Boolean shippingRequired, Boolean shippingTaxable, String shippingClass, Object shippingClassId, String description, String shortDescription, Boolean reviewsAllowed, String averageRating, Integer ratingCount, List<Integer> relatedIds, List<Object> upsellIds, List<Object> crossSellIds, Integer parentId, List<String> categories, List<Object> tags, List<Image> images, String featuredSrc, List<Object> attributes, List<Object> downloads, Integer downloadLimit, Integer downloadExpiry, String downloadType, String purchaseNote, Integer totalSales, List<Object> variations, List<Object> parent, List<Object> groupedProducts, Integer menuOrder) {
        this.title = title;
        this.id = id;
